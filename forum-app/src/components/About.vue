  ...
  <div id="about-page">
    ...
    <main style="display: flex; justify-content: right ; padding: 20px; text-align: center; background-color: #;">
      ...
      <section style="width: 70%; background-color: #f0f0f0; padding: 20px; margin-right: 20px;">
        ...
        <h3>Meet Our Team:</h3>
        <p>Peter Fitzgerald, a tech enthusiast keen on exploring new digital horizons;</p>
        <p>Diarmaid McKeagney, our coding maestro whose technical prowess drives our project's success;</p>
        <p>Igor Pokrzywniak, the master of detail and innovative software development strategies;</p>
        <p>Natalia Kowalska, who at 37, infuses our team with a blend of life experience and insightful perspectives.</p>
        ...
        <h3>What We Offer:</h3>
        <p>We offer a variety of features: real-time chat for instant communication, customizable profiles to reflect individual identities and interests, diverse chat rooms for different topics and study groups, interactive quizzes for learning and fun, and a forum for diverse discussions and engagement.</p>
